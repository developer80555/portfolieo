...
const Header = () => {
  return (
    <div className="w-11/12 max-w-4xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
      ...
      >
        frontend Web Developer based in Siddharthnager
      </motion.h1>
      <motion.p
        initial={{ opacity: 0 }}
      ...
      >
        Building scalable, modern web applications with clean code, seamless
        functionality, and thoughtful design. Turning ideas into impactful
        digital experiences.
      </motion.p>
      <div className="flex flex-col sm:flex-row items-center gap-4 mt-4">
        <motion.a
          ...
          href="#contact"
          className="px-10 py-4 border border-white rounded-full bg-black text-white flex items-center gap-2 dark:bg-transparent"
        >
          contact me{" "}
